...
public class NewsController {
    ...
    public OutputListResult<News> get(@RequestParam(value="page", required=false, defaultValue="1")Integer pageNumber,
                                      @RequestParam(value="page", required=false, defaultValue="1")Integer pageSize) {
    ...
    @GetMapping("/get/{id}")
    public OutputResult<News> getById(@PathVariable("id") Long id) {
